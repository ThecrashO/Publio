# PostPilot — Multi-Platform Social Media Publishing Platform

PostPilot is a lightweight, self-hosted, production-grade social media publishing application built with HTML5, Bootstrap 5, Vanilla JavaScript, and Supabase (Auth, PostgreSQL, Storage, Edge Functions).
...
- **Direct API Communications**: Zero third-party automation dependencies (No Make.com, Zapier, or n8n). PostPilot communicates directly with official social media platform REST and Graph APIs.
...
5. In PostPilot, go to **Social Settings**, enter your Bot Token and Channel ID (e.g. `-1001234567890`), and click **Save Telegram Credentials**.
